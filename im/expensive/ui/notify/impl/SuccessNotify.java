...
extends Notify {
    ...
    public void render(MatrixStack matrixStack, int multiplierY) {
        ...
        if (SuccessNotify.mc.currentScreen instanceof ChatScreen) {
        ...
        float iconSize = ClientFonts.icons_wex[25].getWidth("K");
        ...
        int i = ColorUtils.rgba(109, 255, 86, 60);
        int o = ColorUtils.rgba(72, 255, 44, 20);
        ...
        ClientFonts.icons_wex[26].drawString(matrixStack, "K", (double)posX - ((double)iconSize - 2.5), (double)(posY + this.margin / 2.0f + 2.5f), ColorUtils.reAlphaInt(-1, (int)(255.0 * this.alphaAnimation.getValue())));
