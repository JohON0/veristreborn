...
extends Component {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        this.width = 15.0f;
        this.height = 7.0f;
        int color = ColorUtils.interpolate(ColorUtils.rgb(30, 30, 30), ColorUtils.rgb(129, 132, 151), 1.0f - (float)this.animation.getValue());
        DisplayUtils.drawRoundedRect(this.getX() + this.getWidth() - this.width - 7.0f, this.getY() + this.getHeight() / 2.0f - this.height / 2.0f, this.width, this.height, 3.0f, ColorUtils.rgba(10, 10, 10, 255));
