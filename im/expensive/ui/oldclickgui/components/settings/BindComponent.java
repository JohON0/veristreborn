...
extends Component {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        DisplayUtils.drawShadow(x - 2.0f, y - 2.0f, Fonts.montserrat.getWidth(bind, 5.5f, this.activated ? 0.1f : 0.05f) + 4.0f, 9.5f, 10, ColorUtils.rgba(10, 10, 10, 255));
        DisplayUtils.drawRoundedRect(x - 2.0f, y - 2.0f, Fonts.montserrat.getWidth(bind, 5.5f, this.activated ? 0.1f : 0.05f) + 4.0f, 9.5f, 2.0f, ColorUtils.rgba(10, 10, 10, 160));
        Fonts.montserrat.drawText(stack, bind, x, y, this.activated ? -1 : ColorUtils.rgb(160, 163, 175), 5.5f, this.activated ? 0.1f : 0.05f);
        ...
        this.setHeight(next ? 23.0f : 16.0f);
    }
