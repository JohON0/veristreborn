 ...
 */
package im.expensive.ui.autobuy.api.render;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.platform.GlStateManager;
import im.expensive.ui.autobuy.api.donate.DonateItems;
...
implements IMinecraft {
    ...
    private void renderAddingPanel(MatrixStack matrixStack, float x, float y, float width, float height, int mouseX, int mouseY) {
        ...
        DisplayUtils.drawShadow(x, y, width, height, 16, ColorUtils.rgba(28, 28, 28, (int)(255.0 * this.hoveredAnimation.getOutput())));
        DisplayUtils.drawRoundedRect(x, y, width, height, 4.0f, ColorUtils.rgba(23 + fade, 23 + fade, 23 + fade, 255));
        float fontHeight = Fonts.montserrat.getHeight(12.0f);
        Fonts.montserrat.drawCenteredText(matrixStack, this.itemMenuOpened ? "\u0417\u0430\u043a\u0440\u044b\u0442\u044c" : "\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043f\u0440\u0435\u0434\u043c\u0435\u0442", x + width / 2.0f, y + height / 2.0f - fontHeight / 2.0f, ColorUtils.rgba(255, 255, 255, 128), 12.0f);
    }
