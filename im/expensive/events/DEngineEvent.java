...
public class DEngineEvent {
    ...
    public DEngineEvent(MatrixStack matrix, Matrix4f projectionMatrix, ActiveRenderInfo activeRenderInfo, WorldRenderer context, float partialTicks, long finishTimeNano, double cx, double cy, double cz) {
        this.matrix = matrix;
